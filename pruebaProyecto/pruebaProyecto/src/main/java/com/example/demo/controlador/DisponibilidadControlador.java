...
public class DisponibilidadControlador {
	...
	public List<Disponibilidad> obtenerLista(){
		return repositorioD.findAll();}
	
	
	@PostMapping("/buscFecha")
	public List<Disponibilidad> verDispo(@RequestBody String fecha) {
		return this.repositorioD.findByFecha(fecha);
	}
